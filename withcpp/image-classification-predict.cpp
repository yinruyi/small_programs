...
int main(int argc, char* argv[]) {
    ...
    BufferFile json_data("/home/kb539/mxnet/model/Inception/Inception_BN-symbol.json");
    BufferFile param_data("/home/kb539/mxnet/model/Inception/Inception_BN-0039.params");
    ...
    std::vector<std::string> synset = LoadSynset("/home/kb539/mxnet/model/Inception/synset.txt");
...
BOOST_PYTHON_MODULE(image-classification-predict)
{
    def("main", main);
}